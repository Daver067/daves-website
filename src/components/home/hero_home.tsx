...
const HeroHome = () => {
  return (
    <div className="w-full my-10 bg-zinc-800 lg:px-60 px-6 ">
        ...
        <section className="pt-6  md:pt-16">
          <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 flex-col flex md:flex-row gap-10  ">
            <div className="max-w-2xl mx-auto text-center m-auto ">
              ...
              <p className="mt-8 md:mt-5 text-2xl font-bold leading-tight text-gray-100 sm:leading-tight md:text-3xl lg:leading-tight font-poppins">
                The software developer that will meet your needs
              </p>
            </div>
            <Image
              src={daverPhoto}
              className="md:w-48 rounded-full w-44 m-auto pt-6 md:pt-0"
              alt="Avatar"
            />
          </div>
        </section>
